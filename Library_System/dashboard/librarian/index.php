...
<ul class="sidebar-menu">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li><a href="<?= BASE_URL ?>/dashboard/librarian/manage_users_students.php">Students</a></li>
            <li><a href="<?= BASE_URL ?>/dashboard/librarian/manage_users_admin.php">Admin</a></li>
        </ul>
    </li>
